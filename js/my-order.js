            ...
            return `
                <div class="item ${(item.status === "Từ chối nhận") ? "order-cancel" : ""}">
                    ...
                    <div class="footer ${(item['status-pay'] === "payied" || item.status === "Từ chối nhận") ? 'hidden' : ''}">
                        ...
                        <div style="display: flex;">
                            <a style="text-decoration: none;" href="${(item.supporter === "Trung")?"https://www.facebook.com/profile.php?id=100023143774485":""}${(item.supporter === "Tùng")?"https://www.facebook.com/profile.php?id=100047562911895":""}${(item.supporter === "Thành")?"":""}${(item.supporter === "Trà")?"":""}">
